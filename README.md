...
Este projeto é uma aplicação React que busca repositórios de usuários do Github e vai adicionando eles em uma lista no layout da interface. O projeto é a solução de um dos desafios da DIO. Clique [aqui](https://github.com/digitalinnovationone/trilha-react-desafio-2) para saber mais.  
...
- [x] Buscar repositórios de usuários no Github com API
- [x] Listar repositórios 
- [x] Excluir repositórios com estado local  
...
```bash 
    git clone https://github.com/Gustavo-Victor/repo-wiki.git
```
